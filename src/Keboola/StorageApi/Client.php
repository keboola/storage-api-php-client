...
class Client
{
    ...
    {
        $url = "storage/shared-buckets/" . $projectId . '/detail/' . $bucketId;
    ...
    public function getSharedBucketsForProject($projectId, $options = [])
    {
        $url = "storage/shared-buckets/" . $projectId . '/detail';
