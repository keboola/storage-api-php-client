 ...
 * [BC break] `Components::getComponentConfigurations` method renamed to `Components::getComponentConfigurations` and accept only one param (object of `ListComponentConfigurationsOptions`)
