...
class ExportSimpleTest extends StorageApiTestCase
{
     ...
     */
    public function testTableExportAsyncSliced(array $exportOptions, array $expectedResult, int $expectedColumnsCount, array $ignoreColumnKeys): void
    {
    ...
    public function tableExportSimpleProvider(): \Generator
    {
        yield 'basic' => [
            [],
            [
