...
class SnowflakeRealBranchesTest extends ParallelWorkspacesTestCase
{
    ...
    public function testBucketsVisibilityBetweenBranchWorkspaces(): void
    {
        ...
        $wsDefault = $this->initTestWorkspace(self::BACKEND_SNOWFLAKE, [], true, true, $this->_client, $this->workspaceSapiClient);
        ...
        try {
            (new Workspaces($this->workspaceSapiClient->getBranchAwareClient($branchId)))->getWorkspace($wsDev['id']);
