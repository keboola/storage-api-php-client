...
define('STORAGE_API_PROJECT_IDS_IN_ORGANIZATION', getenv('STORAGE_API_PROJECT_IDS_IN_ORGANIZATION'));
define('STORAGE_API_PROJECT_IDS_NOT_IN_ORGANIZATION', getenv('STORAGE_API_PROJECT_IDS_NOT_IN_ORGANIZATION'));
define('STORAGE_API_PROJECT_ID_AVAILABLE_TO_LINK', getenv('STORAGE_API_PROJECT_ID_AVAILABLE_TO_LINK'));
define('STORAGE_API_PROJECT_ID_NOT_AVAILABLE_TO_LINK', getenv('STORAGE_API_PROJECT_ID_NOT_AVAILABLE_TO_LINK'));
