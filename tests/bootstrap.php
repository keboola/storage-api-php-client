...
define('STORAGE_API_TOKEN_WITH_OTHER_ADMIN_IN_SAME_ORGANIZATION', getenv('STORAGE_API_TOKEN_WITH_OTHER_ADMIN_IN_SAME_ORGANIZATION'));
define('STORAGE_API_TOKEN_WITH_OTHER_ADMIN_IN_OTHER_ORGANIZATION', getenv('STORAGE_API_TOKEN_WITH_OTHER_ADMIN_IN_OTHER_ORGANIZATION'));
