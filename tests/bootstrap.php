...
define('MANAGE_API_TOKEN_FOR_TOKENS_TEST', getenv('MANAGE_API_TOKEN_FOR_TOKENS_TEST'));
define('MANAGE_API_APPLICATION_TOKEN_WITHOUT_SCOPES_FOR_TOKENS_TEST', getenv('MANAGE_API_APPLICATION_TOKEN_WITHOUT_SCOPES_FOR_TOKENS_TEST'));
define('MANAGE_API_APPLICATION_TOKEN_WITH_PROTECTED_BRANCH_SCOPE_FOR_TOKENS_TEST', getenv('MANAGE_API_APPLICATION_TOKEN_WITH_PROTECTED_BRANCH_SCOPE_FOR_TOKENS_TEST'));
