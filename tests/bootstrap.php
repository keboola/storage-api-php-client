...
define('STORAGE_API_TOKEN_USER_WITH_OTHER_EMAIL', getenv('STORAGE_API_TOKEN_USER_WITH_OTHER_EMAIL'));
define('STORAGE_API_TOKEN_USER_EMAIL_IN_OTHER_ORG', getenv('STORAGE_API_TOKEN_USER_EMAIL_IN_OTHER_ORG'));
