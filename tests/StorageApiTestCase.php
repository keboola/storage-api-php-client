...
abstract class StorageApiTestCase extends ClientTestCase
{
    ...
    protected function listJobsByRunId(string $runId): array
    {
        return array_filter(
            $this->_client->listJobs(),
            static fn($job) => $job['runId'] === $runId,
        );
    }
    ...
    protected function resolveBranchClients(array $client1, int $branchId, array $client2): array
    {
