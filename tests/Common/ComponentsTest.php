...
class ComponentsTest extends StorageApiTestCase
{
    ...
    public function testComponentConfigRestore($clientType): void
    {
        ...
        $configurationRow = new ConfigurationRow($config);
    ...
    public function testComponentConfigRestrictionsForReadOnlyUser(): void
    {
        ...
        $componentsForAdmin = new Components($this->client);
        $componentsForAdmin->addConfiguration($configuration);

        $components = $componentsForAdmin->listComponents();
        $this->assertCount(1, $components);

        $componentsForReadOnlyUser = new Components($readOnlyClient);
    ...
    {
        $components = new Components($this->client);
        $component = $components->addConfiguration((new Configuration())
            ->setComponentId('wr-db')
            ->setName('Main')
            ->setDescription('some desc'));
    ...
    public function testComponentConfigUpdateChangeDescription(): void
    {
        ...
        $secondConfigToPut = (new Configuration());
    ...
    public function testTokenWithComponentAccess(): void
    {
        ...
        $config = $components->addConfiguration((new Configuration())
            ->setComponentId('provisioning')
            ->setName('Main'));
     ...
     * @dataProvider provideComponentsClientType
     */
    public function testComponentConfigRowWithRowId(): void
    {
        $configuration = new Configuration();
        $configuration
            ->setComponentId('wr-db')
        ...
        $configurationRow = (new ConfigurationRow($configuration))->setRowId(null);
        $createdRow = $components->addConfigurationRow($configurationRow);

        self::assertArrayHasKey('id', $createdRow);
        self::assertIsNumeric($createdRow['id']); // autogenerated numeric ID by KBC
        self::assertIsString($createdRow['id']);

        $configurationRow = (new ConfigurationRow($configuration))->setRowId(12345678);
        $createdRow = $components->addConfigurationRow($configurationRow);

        self::assertArrayHasKey('id', $createdRow);
        self::assertSame('12345678', $createdRow['id']);

        $configurationRow = (new ConfigurationRow($configuration))->setRowId('test');
        $createdRow = $components->addConfigurationRow($configurationRow);

        self::assertArrayHasKey('id', $createdRow);
        self::assertSame('test', $createdRow['id']);
    }
    ...
    public function testComponentConfigRowUpdateName(): void
    {
        ...
        $updateConfigurationRow = new ConfigurationRow($configuration);
    ...
    public function testComponentConfigRowUpdate(): void
    {
        ...
        $newComponents = new Components($newClient);
    ...
    public function testChangeDescription(): void
    {
        ...
        $rowConfig = new ConfigurationRow($componentConfig);
        $firstRowConfig = ['first' => 1];
        $rowConfig
    ...
    public function testConfigurationNameAndDescriptionShouldNotBeTrimmed(): void
    {
        ...
        $config = $components->updateConfiguration((new  Configuration())
            ->setComponentId('wr-db')
            ->setConfigurationId('main-1')
            ->setName("name2\n")
